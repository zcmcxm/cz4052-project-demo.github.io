function responsiveChat(element) {
  ...
  function showLatestMessage() {
    $(element)
      .find(".messages")
      .scrollTop($(element).find(".messages").height());
  }
  showLatestMessage();
...
responsiveChatPush(
  ...
  "me",
  "08.04.2024 14:33:32",
  "We are presenting to you our AWD FA-4 Project."
);
responsiveChatPush(
  ".chat",
  "Chhavi",
  "me",
  "08.04.2024 14:33:32",
  "Ayushi, Ekta and I hope you like this project."
);
responsiveChatPush(
  ".chat",
  "Chhavi",
